...
class FileType(str, Enum):
    ...
    REPORT = "REPORT"
    OTHER = "OTHER"
    # Patient photos (guided upload)
    FRONT_FACE = "FRONT_FACE"
    SIDE_PROFILE = "SIDE_PROFILE"
    SMILE_PHOTO = "SMILE_PHOTO"
    UPPER_OCCLUSAL_PHOTO = "UPPER_OCCLUSAL_PHOTO"
    LOWER_OCCLUSAL_PHOTO = "LOWER_OCCLUSAL_PHOTO"
...
class ToothInstructionType(str, Enum):
    ...
    IPR_PLANNED = "IPR_PLANNED"
    NO_IPR = "NO_IPR"
    NO_ELASTIC = "NO_ELASTIC"
